require 'pry'
class Song #accepts name upon initialization and set that property correctly.

  attr_accessor :name, :artist, :genre 

  @@all = []

  def initialize(name, artist = nil, genre = nil) #name property should be readable and writable by object
    @name = name 
